...
//	}
        ...
        mScanDeviceDialog = new AlertDialog.Builder(mainContext)
                .setTitle("BLE Device Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (device == null)
                            return;
                        scanLeDevice(false);
                        Log.d("BLUNO", "onListItemClick " + device.getName().toString());

                        Log.d("BLUNO", "Device Name:" + device.getName() + "   " + "Device Name:" + device.getAddress());
                ...
                .setOnCancelListener(new DialogInterface.OnCancelListener() {
                    ...
                    public void onCancel(DialogInterface arg0) {
                        Log.d("BLUNO", "mBluetoothAdapter.stopLeScan");
    ...
    public void onResumeProcess() {
        Log.d("BLUNO", "BlUNOActivity onResume");
    ...
    public void onPauseProcess() {
        Log.d("BLUNO", "BLUNOActivity onPause");
        scanLeDevice(false);
...
//			mBluetoothLeService.close();
    ...
    public void onStopProcess() {
        Log.d("BLUNO", "MiUnoActivity onStop");
        if (mBluetoothLeService != null) {
//			mBluetoothLeService.disconnect();
//            mHandler.postDelayed(mDisonnectingOverTimeRunnable, 10000);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
      ...
      //      Log.d("BLUNO", "mGattUpdateReceiver->onReceive->action=" + action);
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                for (BluetoothGattService gattService : mBluetoothLeService.getSupportedGattServices()) {
                    Log.d("BLUNO", "ACTION_GATT_SERVICES_DISCOVERED  " +
                ...
                Log.d("BLUNO", "displayData " + intent.getStringExtra(BluetoothLeService.EXTRA_DATA));

//            	mPlainProtocol.mReceivedframe.append(intent.getStringExtra(BluetoothLeService.EXTRA_DATA)) ;
//            	System.out.print("mPlainProtocol.mReceivedframe:");
//            	Log.d("BLUNO",mPlainProtocol.mReceivedframe.toString());
...
//			mBluetoothLeService.close();
    ...
    void scanLeDevice(final boolean enable) {
        if (enable) {
            ...
            Log.d("BLUNO", "mBluetoothAdapter.startLeScan");
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            Log.d("BLUNO", "mServiceConnection onServiceConnected");
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            Log.d("BLUNO", "mServiceConnection onServiceDisconnected");
            mBluetoothLeService = null;
        }
    };
    ...
    private BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice device, int rssi,
            ...
            ((Activity) mainContext).runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("BLUNO", "mLeScanCallback onLeScan run ");
    ...
    private void getGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            Log.d("BLUNO", "displayGattServices + uuid=" + uuid);
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (uuid.equals(ModelNumberStringUUID)) {
                    ...
                    Log.d("BLUNO", "mModelNumberCharacteristic  " + mModelNumberCharacteristic.getUuid().toString());
                } else if (uuid.equals(SerialPortUUID)) {
                    mSerialPortCharacteristic = gattCharacteristic;
                    Log.d("BLUNO", "mSerialPortCharacteristic  " + mSerialPortCharacteristic.getUuid().toString());
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                Log.d("BLUNO", "mInflator.inflate  getView");
